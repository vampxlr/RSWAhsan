...
<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/functions/shortcodegens/textboxes/tinymce.js?1.5"></script>
<style type="text/css">
...
<form name="mtheme_textboxes" action="#">
	<!-- style_panel -->
	<fieldset>
		<legend>Alignment</legend>
		<select id="textbox_alignment" name="textbox_alignment">
	...
	<fieldset>
		<legend>Width</legend>
		<input id="textbox_width" value="300" name="textbox_width" type="text">
	</fieldset>
