<?php
class add_mtheme_thumbnails {
	
	var $pluginname = 'mtheme_thumbnails';
	var $path = '';
	var $internalVersion = 100;
	
	function add_mtheme_thumbnails()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/functions/shortcodegens/thumbnails/';	
	...
	function add_tinymce_langs_path($plugin_array) {
		...
		$plugin_array[$this->pluginname] = get_template_directory_uri() . '/functions/shortcodegens/thumbnails/langs.php';
		return $plugin_array;
	}
...
$tinymce_button = new add_mtheme_thumbnails ();
