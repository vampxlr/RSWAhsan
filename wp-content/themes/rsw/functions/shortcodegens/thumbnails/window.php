...
<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/functions/shortcodegens/thumbnails/tinymce.js?1.2"></script>
<style type="text/css">
...
<form name="mtheme_type" action="#">
	...
	<fieldset>
		...
		<td>
			<legend>Width</legend>
			<input id="thumbnail_width" name="thumbnail_width" value="206" type="text" style="width:145px">

		</td>
		<td>
			<legend>Height</legend>
			<input id="thumbnail_height" name="thumbnail_height" value="137" type="text" style="width:145px">
