...
<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/functions/shortcodegens/notices/tinymce.js?1.1"></script>
<style type="text/css">
...
<form name="mtheme_type" action="#">
	...
	<fieldset>
		...
		<select id="notices_shortcode" name="notices_shortcode">
			<option value="yellow">Yellow notice</option>
			<option value="red">Red notice</option>
			<option value="blue">Blue notice</option>
			<option value="green">Green notice</option>
		</select>
	</fieldset>
