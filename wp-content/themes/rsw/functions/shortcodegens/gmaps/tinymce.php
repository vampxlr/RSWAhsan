<?php
class add_mtheme_gmaps {
	
	var $pluginname = 'mtheme_gmaps';
	var $path = '';
	var $internalVersion = 100;
	
	function add_mtheme_gmaps()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/functions/shortcodegens/gmaps/';	
	...
	function add_tinymce_langs_path($plugin_array) {
		...
		$plugin_array[$this->pluginname] = get_template_directory_uri() . '/functions/shortcodegens/gmaps/langs.php';
		return $plugin_array;
	}
...
$tinymce_button = new add_mtheme_gmaps ();
