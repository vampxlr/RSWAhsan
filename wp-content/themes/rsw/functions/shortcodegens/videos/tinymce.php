<?php
class add_mtheme_videos {
	
	var $pluginname = 'mtheme_videos';
	var $path = '';
	var $internalVersion = 100;
	
	function add_mtheme_videos()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/functions/shortcodegens/videos/';	
	...
	function add_tinymce_langs_path($plugin_array) {
		...
		$plugin_array[$this->pluginname] = get_template_directory_uri() . '/functions/shortcodegens/videos/langs.php';
		return $plugin_array;
	}
...
$tinymce_button = new add_mtheme_videos ();
