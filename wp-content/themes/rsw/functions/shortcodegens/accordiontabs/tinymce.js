function insertTypeShortcode() {
	...
	if (shortcodeId != 0 && shortcodeId == 'accordion' ){
		shortcodeText = '<br />[accordiontabs]<br />[tab title="Tab1"]<br />' + sampletext1 + '<br />[/tab]<br />[tab title="Tab2"]<br />' + sampletext2 + '<br />[/tab]<br />[tab title="Tab3"]<br />' + sampletext3 + '<br />[/tab]<br />[/accordiontabs]<br />';	
		}
