...
function optionsframework_init() {
	...
	if (isset( $_POST['update'] )) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Settings Saved', 'optionsframework' ), 'updated fade' );
		$clean = array();
...
function optionsframework_load_scripts() {
	...
	wp_enqueue_script("range_script", OPTIONS_FRAMEWORK_DIRECTORY."js/rangeinput.js", array( 'jqueryui' ), "1.0");
	wp_enqueue_script("iphonecheckbox_script", OPTIONS_FRAMEWORK_DIRECTORY."js/iphone-style-checkboxes.js", array( 'jquery' ), "1.0");
